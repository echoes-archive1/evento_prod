...
<head>
    ...
    <title>Club Events - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="club-events.php" class="nav-item active">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="main-content">
        <header class="header">
            <div class="header-left">
                ...
                <p class="page-subtitle">Manage your club's events</p>
            </div>
        ...
        <div class="content-wrapper">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <h3>No Events Yet</h3>
                    <p>Your club hasn't created any events yet.</p>
                    <a href="create-event.php" class="btn btn-primary" style="margin-top: 1rem;">Create First Event</a>
                </div>
            <?php endif; ?>
        </div>
    </main>
